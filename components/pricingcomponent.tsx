...
export const PricingWrapper: React.FC<{
  ...
  <article
    className={cn(
      'min-h-[500px] h-[800px] max-h-[700px] max-w-[800px] w-full bg-black relative overflow-hidden rounded-2xl text-black', // Updated height and width
      className
    )}
  >
    <span
...
const Cross = () => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M11 11L118.899 119M11.101 119L119 11" stroke="#000000" strokeWidth="31" />
  </svg>
);
